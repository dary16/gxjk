<template>
    <keep-alive>
        <div class="about">
            ...
            <van-loading size="30px" text-size="16px" type="spinner" style="margin-top:2rem;" vertical v-if="showLoading">加载中...</van-loading>
            <div class="content" v-else>
                <div class="img">
                    <div class="noImg" v-if="length === 0">
                        <img src="../../assets/noimg.jpg" />
                    </div>
                    <van-swipe :autoplay="3000" indicator-color="black">
                        <van-swipe-item v-for="(image, index) in images" :key="index">
                            <van-image :src="image" v-lazy="image" @click="swiperImgClick()" />
                        </van-swipe-item>
                    </van-swipe>
                </div>
                <div class="address clearfix" @click="toMap">
                    <div class="left fl">
                ...
                <div class="btns" v-show="isShowBtn">
                    <div class="all-btn" style="color:#2d92fd" @click="toMap">
                        导航至报警点
                    </div>
                    <div class="all-btn" style="color:#F69434;" @click="commitFn">
                        结果反馈
                    </div>
                </div>
            </div>
